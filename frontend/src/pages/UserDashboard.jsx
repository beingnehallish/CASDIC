...
// import { useTheme } from "../context/ThemeContext.jsx"; // 1. Import
...
import { useNavigate } from "react-router-dom";
import axios from "axios";
// This path assumes 'styles' is a sibling of 'pages' (i.e., src/styles)
import "../styles/UserDashboard.css";

// import modularized citizen components
// This path assumes 'citizen' is a sibling of 'pages' (i.e., src/citizen)
import Technologies from "./citizen/Technologies";
import Projects from "./citizen/Projects";
import Patents from "./citizen/Patents";
import Publications from "./citizen/Publications";
...
// Import for theme toggling
// This path assumes 'context' is a sibling of 'pages' (i.e., src/context)
import { useTheme } from "../context/ThemeContext.jsx";
import { FaMoon, FaSun } from "react-icons/fa";

// This is the one and only UserDashboard component
export default function UserDashboard() {
  // Theme hook
    ...
    <div className="user-dashboard">
      <div className="dashboard">
        ...
        <nav className="navbar">
          ...
          {/* --- This is the theme toggle button I added --- */}
          <button className="theme-toggle" onClick={toggleTheme} title="Toggle theme">
            {theme === "dark" ? <FaSun /> : <FaMoon />}
          </button>
        ...
        {["Technologies", "Projects", "Patents", "Publications"].includes(view) && (
          <div className="search-bar1">
            <input
              ...
              placeholder={`Search ${view}...`}
              value={searchTerm}
              // --- FIX: Changed e.gittarget.value to e.target.value ---
              onChange={(e) => setSearchTerm(e.target.value)}
            />
          </div>
        )}
